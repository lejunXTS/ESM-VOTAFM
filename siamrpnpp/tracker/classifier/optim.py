import torch
from siamrpnpp.tracker.classifier.libs import optimization, TensorList, operation
import math
from siamrpnpp.core.config import cfg


class FactorizedConvProblem(optimization.L2Problem):
    def __init__(self, training_samples: TensorList, y: TensorList, use_attention: bool,
