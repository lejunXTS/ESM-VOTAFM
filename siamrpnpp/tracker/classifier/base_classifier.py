...
import math
import numpy as np
from siamrpnpp.tracker.classifier.optim import ConvProblem, FactorizedConvProblem
from siamrpnpp.tracker.classifier.libs import TensorList, operation
from siamrpnpp.tracker.classifier.libs import fourier, augmentation, dcf
from siamrpnpp.tracker.classifier.libs.plotting import show_tensor
from siamrpnpp.tracker.classifier.libs.optimization import GaussNewtonCG, ConjugateGradient, GradientDescentL2,  \
...
class BaseClassifier(object):
    ...
    def localize_advanced(self, scores):
        ...
        target_disp1 = max_disp1 - torch.div(self.output_sz, 2, rounding_mode='floor')
        ...
        target_disp2 = max_disp2 - torch.div(self.output_sz, 2, rounding_mode='floor')
