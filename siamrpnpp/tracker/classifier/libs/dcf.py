...
from siamrpnpp.tracker.classifier.libs import fourier
...
def label_function_spatial(sz: torch.Tensor, sigma: torch.Tensor, center: torch.Tensor = torch.zeros(2), scale: torch.Tensor = torch.ones(1), end_pad: torch.Tensor = torch.zeros(2)):
