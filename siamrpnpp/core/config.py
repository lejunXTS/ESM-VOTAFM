...
__C.DATASET.NAMES = ('GOT','VID','YOUTUBEBB','COCO')  #('VID', 'COCO', 'DET', 'YOUTUBEBB', 'GOT')
...
__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = 'data/got/crop511'    #GOT-10K数据集crop511的路径
__C.DATASET.GOT.ANNO = 'data/got/train.json'  #GOT-10K数据集train.json的路径
__C.DATASET.GOT.FRAME_RANGE = 100   #siamcar设置的50 100000
...
__C.DATASET.VIDEOS_PER_EPOCH = 64000 # #默认的数量600000, 64000, 32000,自己调
...
__C.TRACK.USE_CLASSIFIER = True
__C.TRACK.TEMPLATE_UPDATE = True

__C.TRACK.USE_ATTENTION_LAYER=False   #false or true
__C.TRACK.CHANNEL_ATTENTION=False      #false or true
__C.TRACK.SPATIAL_ATTENTION='none' # ['none', 'conv', 'pool']

__C.TRACK.SEED = 12345
__C.TRACK.COEE_CLASS = 0.8
