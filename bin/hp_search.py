...
parser.add_argument('--snapshot', default='models/siamrpnpp_alexnet/snapshot/checkpoint_e43.pth',type=str, help='snapshot of model')
parser.add_argument('--dataset', default='OTB100',type=str, help='dataset name to eval')

parser.add_argument('--penalty-k', default='0.1,0.11,0.12,0.13,0.15,0.16,0.18,0.20', type=parse_range)#0.16 
parser.add_argument('--lr', default='0.15,0.25,0.30,0.31,0.32,0.33,0.34,0.35', type=parse_range) #0.30
parser.add_argument('--window-influence', default='0.30,0.32,0.34,0.35,0.36,0.38,0.40,0.42,0.45', type=parse_range)#0.40  
    
parser.add_argument('--search-region', default='287', type=parse_range_int)# 287,271,255
