...
tracker_name='checkpoint_e42'    #跟踪器的名字,就是保存txt文件的名字
dataset='OTB100'   #选择测试集,OTB100,DTB,UAV123,GOT-10K等等

parser = argparse.ArgumentParser(description='tracking evaluation')
parser.add_argument('--tracker_path', '-p', default='./results', type=str,
                    help='tracker result path')      #跟踪器的保存位置,即tracker_name的保存位置
